...
class SummaryDialog {
  ...
  static Future<void> show(BuildContext outerContext,
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                if (count == null || count <= 0) {
                  if (outerContext.mounted) {
                    ScaffoldMessenger.of(outerContext).showSnackBar(
                      const SnackBar(content: Text("참가 인원을 숫자로 올바르게 입력해주세요.")),
                    );
                  }
                  return;
                }
                ...
                if (outerContext.mounted) Navigator.of(outerContext).pop(); // 로딩 닫기
                if (dialogContext.mounted) Navigator.of(dialogContext).pop(); // 다이얼로그 닫기
              },
